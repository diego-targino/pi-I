...
CSRF_TRUSTED_ORIGINS = _get_env_list(
    ...
    "http://localhost:8000,http://127.0.0.1:8000,http://0.0.0.0:8000,http://host.docker.internal:8000"
)
...
MIDDLEWARE = [
    ...
    'core.middlewares.api_logger.APILoggerMiddleware',
]

REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "core.authentication.jwt_authentication.JwtAuthentication"
    ],
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'UFC Plant Analysis API',
    'DESCRIPTION': 'API para análise de plantas e gestão de usuários',
    'VERSION': '1.0.0',
    'SERVE_PERMISSIONS': ['rest_framework.permissions.AllowAny'],
    'CONTACT': {
        'name': 'UFC Plant Analysis',
